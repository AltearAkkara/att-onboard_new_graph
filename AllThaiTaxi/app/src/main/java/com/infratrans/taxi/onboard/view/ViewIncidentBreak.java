 ...
 */
public class ViewIncidentBreak extends RelativeLayout {
    ...
    public ViewIncidentBreak(Context context, ViewIncidentListener listener) {
        ...
        v = vi.inflate(R.layout.dialog_incidentbreak, null);
        addView(v);

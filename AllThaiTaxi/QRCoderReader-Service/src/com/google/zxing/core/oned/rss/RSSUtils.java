...
public final class RSSUtils {
	...
	public static int[] getRSSwidths(int val, int n, int elements, int maxWidth, boolean noNarrow) {
	...
	public static int combins(int n, int r) {
	...
	public static int[] elements(int[] eDist, int N, int K) {

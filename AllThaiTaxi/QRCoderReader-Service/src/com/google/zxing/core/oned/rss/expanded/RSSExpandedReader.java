...
public final class RSSExpandedReader extends AbstractRSSReader{
	...
	private static final int FINDER_PAT_A = 0;
  	...
  	public Vector decodeRow2pairs(int rowNumber, BitArray row) throws NotFoundException {
  	...
  	// not private for testing
  	public ExpandedPair retrieveNextPair(BitArray row, Vector previousPairs, int rowNumber) throws NotFoundException{

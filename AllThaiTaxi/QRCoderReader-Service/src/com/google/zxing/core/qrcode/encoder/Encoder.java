...
import com.google.zxing.core.common.ECI;
...
public final class Encoder {
	...
	/**
  	...
  	*/
	public static void appendLengthInfo(int numLetters, int version, Mode mode, BitArray bits) throws WriterException {
	...
	public static void appendAlphanumericBytes(String content, BitArray bits) throws WriterException {

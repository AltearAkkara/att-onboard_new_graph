...
public final class BitMatrixParser {
	 ...
	 */
	public int[] readCodewords() throws FormatException {
	 ...
	 *         this row.
	 */
	public int processRow(int[] rowCounters, int rowNumber, int rowHeight, int[] codewords, int next) throws FormatException {
